...
const InventoryDialog = ({
    ...
    const fetchCollections = async () => {
      if (book && isOpen) {
        ...
        try {
          ...
          const baseUrl = import.meta.env.VITE_API_URL || '';
          const response = await axios.get(`${baseUrl}/api/vol-book/${book.book_id}/collections`, {
            headers: {
              'Authorization': `Bearer ${token}`,
            },
          });
  ...
  const handleSaveInventory = async () => {
    try {
      ...
      const baseUrl = import.meta.env.VITE_API_URL || '';
      await axios.put(`${baseUrl}/api/vol-book/${book.book_id}/collections`, payload, {
        headers: {
          'Authorization': `Bearer ${token}`,
...
const VolBookManagementPage = () => {
  ...
  const handleDeleteBook = async (bookId) => {
    ...
    try {
      ...
      await axios.delete(`${baseUrl}/api/vol-book/${bookId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
...
export default VolBookManagementPage;